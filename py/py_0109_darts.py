...
# split into twenty equal sized sections numbered one to twenty. The score of 
# a dart is determined by the number of the region that the dart lands in. A 
...
# checkout on a score of 6: 
# D3D1D2S2D2D2D1S4D1S1S1D2S1T1D1S1S3D1D1D1D1D1S2D1S2S2D1Note that D1 D2 is 
# considered different to D2 D1 as they finish on different doubles. However, 
# the combination S1 T1 D1 is considered the same as T1 S1 D1. In addition we 
