...
# anti-diagonal) is 16 (= 8 + 7 + 1). −25329−6513273−18−4 8Now, let us repeat 
# the search, but on a much larger scale:First, generate four million 
...
# adjacent entries in any direction (horizontal, vertical, diagonal or 
# anti-diagonal).
# 
