...
# positive integer matrix in two different ways. Here is an 
# example:$$\begin{pmatrix}40 & 12\\48 & 40\end{pmatrix} =\begin{pmatrix}2 & 
# 3\\12 & 2\end{pmatrix}^2 =\begin{pmatrix}6 & 1\\4 & 6\end{pmatrix}^2$$We 
