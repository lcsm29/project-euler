...
# whereas $20!$ can be given the same representation in $41680$ ways. Let 
# $F(n)$ denote the number of ways in which $n$ can be written as a product of 
# one natural number, two squares, three cubes and four fourth powers. You are 
# given that $F(25!)=4933$, $F(100!) \bmod 1\,000\,000\,007=693\,952\,493$,and 
# $F(1\,000!) \bmod 1\,000\,000\,007=6\,364\,496$. Find $F(1\,000\,000!) \bmod 
# 1\,000\,000\,007$.
# 
