...
# number of primesnot exceeding $n$. E. g. $\pi(6)=3$ and $\pi(100)=25$. We 
# say that a sequence of integers $u = (u_0,\cdots,u_m)$ is a $\pi$ sequence 
# if $u_n \ge 1$ for every $n$ $u_{n+1}= \pi(u_n)$ $u$ has two or more 
# elementsFor $u_0=10$ there are three distinct $\pi$ sequences: (10,4), 
...
# larger than 0. You are given: P(10)=3×8×9×3=648 and P(100)=31038676032. Find 
# $P(10^8)$. Give your answer modulo 1000000007.
# 
