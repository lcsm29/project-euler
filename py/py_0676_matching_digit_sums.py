...
# \ne d(9,2)$. However, for some numbers $i$ there will be a match, like 
...
# $M(100,8,2)=292$ and $M(10^6,8,2)=19173952$. Find $\displaystyle 
# \sum_{k=3}^6 \sum_{l=1}^{k-2}M(10^{16},2^k,2^l)$, giving the last 16 digits 
# as the answer.
# 
