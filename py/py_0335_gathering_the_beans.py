...
# situation appears again. For example with 5 bowls he acts as follows:So with 
# 5 bowls it takes Peter 15 moves to return to the initial situation. Let M(x) 
...
# = 10920. Find $\displaystyle \sum_{k=0}^{10^{18}} M(2^k + 1)$. Give your 
# answer modulo 79.
# 
